 ...
 * @return array
 */
function tutopti_is_valid_serial_key( $serial_key ) {
    // API URL
 ...
 * @return array
 */
function tutopti_is_ip_registered() {
    // API URL
 ...
 * @return array
 */
function tutopti_register_server_info( $serial_key ) {
    global $tutopti;
 ...
 * @return array
 */
function tutopti_deactivate( $serial_key ) {
    // API URL
 ...
 * @return array
 */
function tutopti_verify() {
    // Check if this IP is registered
    $ip_registered = tutopti_is_ip_registered();
    // Check if serial is valid
    $serial_key_valid = tutopti_is_valid_serial_key( get_option( '_tutopti_sk' ) );
...
function social_media_sharing_utility() {
    ...
    echo '
    	<div class="updated social-media-sharing-utility">
            ...
            <a class="ptp-nag-close button-secondary" href="' . $_SERVER['REQUEST_URI'] . '&dismiss_sharing_reminder_tutopti=true">Dismiss</a>
