...
$tutopti_self_term_id = get_option( '_tutopti_term_id_self' );
...
$tutopti_preloads = array(
	array(
        'order' => 1,
        'screen' => 'edit-tutopti_pointer', // this is the page hook we want our pointer to show on
        'page' => 'edit.php',
        'target' => '#wp-admin-bar-tutopti-parent > a', // the css selector for the pointer to be tied to, best to use ID's
        ...
        'collection' => $tutopti_self_term_id,
	),
    array(
        'order' => 2,
        'screen' => 'edit-tutopti_pointer', // this is the page hook we want our pointer to show on
